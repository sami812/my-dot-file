...
require('lazy').setup({
  ...
  -- Harpoon install
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>a', function()
        harpoon:list():append()
      end, { desc = 'Add current file into the list' })
      vim.keymap.set('n', '<leader>ci', function()
        harpoon:list():clear()
      end, { desc = 'clear current list' })
      vim.keymap.set('n', '<leader>1', function()
        harpoon:list():select(1)
      end, { desc = 'go to the first file' })
      vim.keymap.set('n', '<leader>2', function()
        harpoon:list():select(2)
      end, { desc = 'go to the second file' })
      vim.keymap.set('n', '<leader>3', function()
        harpoon:list():select(3)
      end, { desc = 'go to the third file' })
      vim.keymap.set('n', '<leader>4', function()
        harpoon:list():select(4)
      end, { desc = 'go to the fourth file' })
      vim.keymap.set('n', '<leader>c1', function()
        harpoon:list():remove_at(1)
      end, { desc = 'remove the first file' })
      vim.keymap.set('n', '<leader>c2', function()
        harpoon:list():remove_at(2)
      end, { desc = 'remove the second file' })
      vim.keymap.set('n', '<leader>c3', function()
        harpoon:list():remove_at(3)
      end, { desc = 'remove the third file' })
      vim.keymap.set('n', '<leader>c4', function()
        harpoon:list():remove_at(4)
      end, { desc = 'remove the fourth file' })
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      -- Load matugen-generated colorscheme
      local function load_matugen_colors()
        local f = vim.fn.expand '~/.config/nvim/colors/material.lua'
